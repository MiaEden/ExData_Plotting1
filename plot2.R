...
####################################################
#   Download data, read file and reformat columns
####################################################
...
################################################
# Plot 2: plot of Global_active_power by second 
################################################
...
# call a plotting function plot for Global_active_power by seconds
    with(epcDataMutated, {
    plot(dateTime,
         Global_active_power,
         type = "l",
